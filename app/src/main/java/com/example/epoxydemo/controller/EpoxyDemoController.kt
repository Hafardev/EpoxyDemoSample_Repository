...
import com.example.epoxydemo.view.customView.addChipGroup
    ...
    override fun buildModels(data: List<BaseModel>) {
        data.forEach { dataModel ->
            when (dataModel) {
                ...
                is HorizontalListDataModel -> addItemGroup(dataModel)

                is ChipGroupDataModel -> addChipGroup(dataModel)
